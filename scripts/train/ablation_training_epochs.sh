...
for seed in 42 142857 2225393 20000308 2018011309; do
    ...
    for seq_overlap in 0 1; do
        ...
        for i in $(seq 13 13); do
            ...
            export RUN_NAME="ABLATION_TRAINING_EPOCHS_ctx1024_dataseed${dataset_seed}_str${num_strs}_L${min_len}_${max_len}_occur${in_mode_each_occur}_epoch${epoch}_loc${fix_rstr_loc}_seed${seed}_shuffle${shuffle}_overlap${seq_overlap}_$(date +%m%d%H%M%S)"
